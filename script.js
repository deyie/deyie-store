// ===================================================
// DEYA STORE — SCRIPT UTAMA & FORMAT AUTO-CHAT WA
// ===================================================
...
if (currentProduct) {
  ...
  // Tombol Pesan Sekarang & Auto-Chat WhatsApp dengan Link Katalog QRIS WhatsApp
  document.getElementById("btn-checkout").addEventListener("click", () => {
    ...
    // Menggunakan link katalog QRIS resmi dari WhatsApp pacar Anda
    const qrisCatalogLink = "https://wa.me/p/9834335199951583/628558826428";

    // Format pesan lengkap dengan link katalog di atas agar pratinjau gambar QRIS muncul otomatis di WhatsApp
    const message = 
      `${qrisCatalogLink}\n\n` +
